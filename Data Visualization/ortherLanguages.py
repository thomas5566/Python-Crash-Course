...
url = 'https://api.github.com/search/repositories?q=language:' + topic + '&sort=stars'
r = requests.get(url)
...
chart.title = 'Most-Starred ' + topic + ' Projects on GitHub'
chart.x_labels = names

chart.add('', plot_dicts)
chart.render_to_file( topic + '_repos.svg')